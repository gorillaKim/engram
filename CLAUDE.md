...
`engram-mcp`는 6개의 mission 도구를 포함하여 65개 MCP 도구를 제공하고, `engram-cli`는 15개의 서브커맨드를 제공해 모두 `engram-core`를 참조합니다.
...
- ✅ Phase 1 코어: models / repository / migrations / **MCP tools 65개 ↔ CLI 15 서브커맨드 (1:1 패리티, ADR-0010)**
