...
| MCP 도구       | 현 CLI                | 갭                   | 목표 명령형                                    |
|----------------|-----------------------|----------------------|-----------------------------------------------|
| `epic_create`  | `engram epic create`  | -                    | `engram epic create --project P --title T [--description D]` |
| `epic_get`     | `engram epic get`     | -                    | `engram epic get <id>`                         |
| `epic_list`    | `engram epic list`    | -                    | `engram epic list [--project P] [--status S]`  |
...
| `issue_list`         | `engram issue list`          | `--status`, `--sprint`, `--backlog-only` 인자 미지원 | `engram issue list [--project P] [--epic E] [--sprint S] [--status S] [--backlog-only]` |
...
| 항목                                | 수치  |
|------------------------------------|-------|
| MCP tool_definitions               | **45** |
| MCP dispatch 분기                  | 47 (정의 없는 2건 포함) |
| 1:1 CLI 매핑 존재                  | 28    |
| **CLI 미노출 (구현 필요)**         | **17** |
| 추가 인자 보강 필요 CLI            | 4     |
