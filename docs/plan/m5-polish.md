...
- [x] 모든 필터 동작 (project/priority/showCancelled, client-side)
- [x] 스코프 팽창 시각화 (ScopeExpansionBanner + IssueCard ⚠팽창 배지)
- [x] BlockingGraph 시각화 (@xyflow/react, ego-network 1-hop)
- [x] 규칙 문서 머지, CLAUDE.md 표 갱신 (.claude/rules/agent-demo-gate.md)
- [x] ADR 0006/0007 머지
- [ ] (선택) 도크 뱃지 — 보류
- [ ] (선택) 환경설정 윈도우 — 보류
