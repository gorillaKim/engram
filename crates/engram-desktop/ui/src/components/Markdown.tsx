      ...
      components={{
        ...
        code: ({ children, className }) => {
          ...
          return isBlock
            ...
            : <code className="bg-slate-100 rounded px-1 py-0.5 text-xs font-mono text-indigo-700">{children}</code>;
        },
        ...
        a: ({ href, children }) => <a href={href} target="_blank" rel="noreferrer" className="text-indigo-600 hover:underline">{children}</a>,
        ...
        th: ({ children }) => <th className="text-left px-2 py-1 bg-slate-100 border border-slate-200 font-semibold text-slate-700">{children}</th>,
