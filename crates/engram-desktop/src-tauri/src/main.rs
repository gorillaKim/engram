...
fn main() {
    ...
    builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::retrospective_list,
            commands::retrospective_get,
            commands::retrospective_create,
            commands::retrospective_update,
            commands::retrospective_delete,
            commands::retro_action_item_create,
            commands::retro_action_item_update,
            commands::retro_action_item_delete,
            commands::retro_action_item_convert_to_issue,
